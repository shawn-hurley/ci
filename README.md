...
**E2E UI** | [![Test push to main tier0](https://github.com/konveyor/tackle-ui-tests/actions/workflows/tier0-push-main.yaml/badge.svg?event=push)](https://github.com/konveyor/tackle-ui-tests/actions/workflows/tier0-push-main.yaml) | [![UI All tiers nightly](https://img.shields.io/endpoint?url=https%3A%2F%2Fsajidmansoori12.pythonanywhere.com%2Fretrieve_data%3Fpipeline%3Dui-tier-all-nightly)](https://jenkins-csb-migrationqe-main.dno.corp.redhat.com/view/Konveyor/job/mta/job/konveyor-ui-tiers-all-nightly/)
